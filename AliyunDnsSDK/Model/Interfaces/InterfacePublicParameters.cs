...
{
    public abstract class InterfacePublicParameters
    {
        ...
        /// </summary>
        public abstract string AccessKeyId { get; set; }
        ...
        /// 签名方式，目前支持HMAC-SHA1
        /// </summary>
        public abstract string SignatureMethod { get; set; }
        ...
        /// 签名算法版本，目前版本是1.0
        /// </summary>
        public abstract string SignatureVersion { get; set; }

        /// <summary>
        /// 唯一随机数，用于防止网络重放攻击。用户在不同请求间要使用不同的随机数值
        /// </summary>
        public abstract string SignatureNonce { get; set; }

        /// <summary>
        /// 创建签名
        /// </summary>
        /// <returns></returns>
        protected string StringToSign(string decodeStr)
        {
            return "";
        }
    }
